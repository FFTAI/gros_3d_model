...
public class JointInfo : JointData
{
	...
	private static JointInfo[] JOINTS = new JointInfo[]
	{
			...
			new JointInfo(new UnityBone("ShoulderPitchLeft", Axis.X), Dir.Back ),
			new JointInfo(new UnityBone("ShoulderRollLeft", Axis.Y, -25), Dir.Left),
			new JointInfo(new UnityBone("ShoulderYawLeft", Axis.Z), Dir.Right),
			new JointInfo(new UnityBone("ElbowLeft", Axis.X), Dir.Back),
			new JointInfo(new UnityBone("WristYawLeft", Axis.Z), Dir.Right),
			new JointInfo(new UnityBone("WristPitchRollLeft", Axis.X), Dir.Back, "WristPitchLeft"),
			new JointInfo(new UnityBone("WristPitchRollLeft", Axis.Y), Dir.Left, "WristRollLeft"),

			new JointInfo(new UnityBone("ShoulderPitchRight", Axis.X), Dir.Back),
			new JointInfo(new UnityBone("ShoulderRollRight", Axis.Y, 25), Dir.Left),
			new JointInfo(new UnityBone("ShoulderYawRight", Axis.Z), Dir.Right, Dir.R ),
			new JointInfo(new UnityBone("ElbowRight", Axis.X), Dir.Back, Dir.R ),
			new JointInfo(new UnityBone("WristYawRight", Axis.Z), Dir.Right, Dir.R ),
			new JointInfo(new UnityBone("WristPitchRollRight", Axis.X), Dir.Back, Dir.R,  "WristPitchRight") ,
			new JointInfo(new UnityBone("WristPitchRollRight", Axis.Y), Dir.Left, "WristRollRight"),
